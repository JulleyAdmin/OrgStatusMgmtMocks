// Manufacturing Industry Task Templates Seeder
// This script creates realistic manufacturing task templates for testing and demonstration
...
const manufacturingTemplates = [
  // Production Templates
  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All equipment calibrated and tested",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2", 
        text: "Safety checks completed and documented",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Production targets communicated to team",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Quality control samples taken",
        isRequired: false,
        order: 4
      }
    ],
    ...
    createdBy: "system",
    companyId: "", // Will be set when seeding
    usageCount: 0,
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All products inspected according to specifications",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Defects documented and categorized",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Quality report generated and submitted",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Non-conforming products isolated",
        isRequired: true,
        order: 4
      }
    ],
    ...
    safetyRequirements: [
      "Safe handling of inspection equipment",
      "Proper disposal of rejected materials"
    ],
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All scheduled maintenance tasks completed",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Equipment tested and operational",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Maintenance log updated",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Spare parts inventory checked",
        isRequired: false,
        order: 4
      }
    ],
    ...
    safetyRequirements: [
      ...
      "PPE worn throughout maintenance",
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All safety protocols reviewed and documented",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Hazard identification completed",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Corrective actions identified and prioritized",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Safety report submitted to management",
        isRequired: true,
        order: 4
      }
    ],
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All inventory items counted and recorded",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Discrepancies identified and documented",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Inventory records updated in system",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Reconciliation report generated",
        isRequired: true,
        order: 4
      }
    ],
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All required paperwork completed",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Safety training completed and documented",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Equipment training completed",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Mentor assigned and introduction completed",
        isRequired: true,
        order: 4
      }
    ],
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "Production schedule created for next week",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Resource requirements calculated",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Capacity constraints identified",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Production plan communicated to teams",
        isRequired: true,
        order: 4
      }
    ],
    ...
    safetyRequirements: [
      "Safe working conditions consideration",
      "Overtime limitations compliance"
    ],
...

  {
    ...
    definitionOfDone: [
      {
        id: "dod-1",
        text: "All equipment calibrated according to standards",
        isRequired: true,
        order: 1
      },
      {
        id: "dod-2",
        text: "Calibration certificates generated",
        isRequired: true,
        order: 2
      },
      {
        id: "dod-3",
        text: "Equipment tagged with calibration status",
        isRequired: true,
        order: 3
      },
      {
        id: "dod-4",
        text: "Calibration records updated in system",
        isRequired: true,
        order: 4
      }
    ],
    ...
    safetyRequirements: [
      "Safe handling of calibration equipment",
      "Proper disposal of calibration materials"
    ],
...
// Function to run the seeder (for direct execution)
async function runSeeder() {
  // You can replace this with an actual company ID
  const companyId = process.argv[2] || 'SU6Svsf6iVGdopeWKFqQ' // Default company ID from error logs
  
  if (!companyId) {
    console.error('❌ Please provide a company ID as an argument')
    console.log('Usage: npm run seed:templates <companyId>')
    process.exit(1)
  }
  
  try {
    await seedManufacturingTemplates(companyId)
